...
public class ClipboardBinderProxyHookHandler implements InvocationHandler {
    ...
    public ClipboardBinderProxyHookHandler(IBinder base) {
        this.base = base;
        try {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        if ("queryLocalInterface".equals(method.getName())) {
            ...
            return Proxy.newProxyInstance(proxy.getClass().getClassLoader(),
                    ...
                    new ClipboardBinderHookHandler(base, stub));
        }
